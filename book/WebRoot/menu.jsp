					...
					<TD vAlign=top width=180 bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=3 width=165 align=center border=0>
							<TBODY>
								...
								<TR>
									<TD>
										<TABLE id=table_2 style="DISPLAY: block" cellSpacing=0
											cellPadding=2 width=155 align=center border=0>
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="${ pageContext.request.contextPath }/jsp/book/add4.jsp"
														target=main>－ 修改个人资料</A></TD>
												</TR>
												<TR>
												...
												<TR>
													<TD class=menuSmall><A class=style2 href="customer_list.action"
														target=main>－ 客户列表</A></TD>
												</TR>
												<TR>
													
													<TD class=menuSmall><A class=style2 href="customer_gj.action"
														target=main>－ 客户跟进</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2 href="${ pageContext.request.contextPath }/jsp/book/add.jsp"
														target=main>－ 记事本</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2 href="${ pageContext.request.contextPath }/jsp/book/add3.jsp"
														target=main>－ 添加产品资料</A></TD>
												</TR>
